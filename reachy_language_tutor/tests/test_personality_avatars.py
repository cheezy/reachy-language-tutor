...
import reachy_language_tutor.personality as personality_mod
from reachy_language_tutor.config import config
from reachy_language_tutor.avatars import (
    DEFAULT_AVATAR_FILE,
    avatar_id_for,
    read_avatar_svg,
)
from reachy_language_tutor.personality import save_user_personality
...
def test_avatar_unavailable_raises(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "reachy_language_tutor.personality_routes.read_avatar_svg",
        lambda name: None,
    )
