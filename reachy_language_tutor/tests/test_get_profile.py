...
async def test_a_learner_with_no_history_gets_an_empty_language_list(instance: Path) -> None:
    ...
    assert result == {
        "display_name": "New",
        "languages": [],
        "languages_with_material": ["French", "Italian", "Portuguese", "Spanish"],
        "languages_without_material_yet": ["German"],
    }
...
async def test_every_error_still_says_which_languages_the_robot_teaches(instance: Path) -> None:
    ...
    assert unbound["languages_with_material"] == ["French", "Italian", "Portuguese", "Spanish"]
    ...
    assert no_row["languages_with_material"] == ["French", "Italian", "Portuguese", "Spanish"]
