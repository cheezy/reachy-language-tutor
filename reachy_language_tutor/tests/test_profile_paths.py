...
import reachy_language_tutor.personality as headless_mod
import reachy_language_tutor.profile_store as profile_store_mod
from reachy_language_tutor.config import DEFAULT_PROFILES_DIRECTORY, config
from reachy_language_tutor.personality import (
    list_personalities,
)
from reachy_language_tutor.profile_store import read_profile, write_profile, read_profile_from_directory
...
#     \spaces--pollen-robotics--reachy_language_tutor
...
#   back to the budget: 101 + len("reachy_language_tutor\") (29) = 130.
#
...
def test_explicit_default_profile_does_not_fall_back_to_itself(
    ...
    with caplog.at_level(logging.WARNING, logger="reachy_language_tutor.prompts"):
