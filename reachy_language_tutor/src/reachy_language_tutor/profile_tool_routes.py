...
from reachy_language_tutor.config import LOCKED_PROFILE, config
from reachy_language_tutor.personality import AvailableTool, list_personalities, available_tool_catalog
...
from reachy_language_tutor.tool_settings import (
    RestartCallback,
    apply_tool_change,
